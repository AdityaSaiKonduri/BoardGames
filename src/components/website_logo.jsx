...
function Logo() {
    return (<svg className="w-[68px] h-[68px] text-gray-800 dark:text-white mr-6 hover:rotate-180 hover:text-indigo-500 transition-transform duration-500 transform origin-center cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
